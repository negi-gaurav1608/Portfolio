...
function Contacts() {
    return (
        <div id='Contacts' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16 bg-[#efeacaba]'>
            <h1 className='py-4 text-4xl font-bold text-center text-[#001b5e]'>Contact</h1>
            <form action="https://getform.io/f/arollpxb" method="POST" encType='multipart/form-data'>
                ...
                <div className='flex flex-col py-2'>
                    ...
                    <textarea className='border-2 rounded-lg p-3 flex border-gray-300' rows='10' name='message' required/>
                </div>
