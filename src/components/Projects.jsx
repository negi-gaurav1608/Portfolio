...
function Projects() {
    return (
        <div id='projects' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
            ...
            <p className='text-center pt-8'>As a passionate frontend developer, I've dedicated my time to creating dynamic and user-friendly web interfaces. My projects span various domains and showcase my skills in HTML, CSS, JavaScript, and modern frameworks like ReactJs.</p>
